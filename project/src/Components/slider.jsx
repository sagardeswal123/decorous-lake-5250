...
export const ChakraSlider = (props) => {
  ...
  return (
    <Box width={props.width} padding={"2%"}>
      ...
      <Slider aria-label="slider-ex-1"  onChange={handleChange} value={value} min={+props.min} max={+props.max} step={+props.steps}>
        <SliderTrack>
          <SliderFilledTrack  bg="#51defc" />
        </SliderTrack>
        <SliderThumb  bg='#6af884'/>
      </Slider>
